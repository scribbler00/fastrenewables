# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00d_baselines.ipynb.

# %% auto 0
__all__ = ['tmp', 'test_acts', 'truncated_svd', 'prep_fixed_point_empircal_bayes', 'evidence_fixed_point', 'BayesLinReg',
           'RidgeRegression', 'relu', 'identity', 'sigmoid', 'ELM', 'sample_bayes_linear_model', 'MCLeanPowerCurve']

# %% ../nbs/00d_baselines.ipynb 2
#| include: false
import numpy as np
