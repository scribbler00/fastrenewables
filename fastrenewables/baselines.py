...
__all__ = ['BayesLinReg', 'RidgeRegression', 'relu', 'identity', 'sigmoid', 'ELM', 'EchoStateRegression',
           'RocketReservoirRegression']
...
class ELM(BaseEstimator):
    ...
    def _convert_activations(self, activations):
        ...
        for activation in activations:
            if type(activation) is str and activation in supported_activations:
                activation = conversion_dict[activation]
