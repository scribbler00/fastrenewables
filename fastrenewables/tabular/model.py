# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/03_tabular.model.ipynb.

# %% auto 0
__all__ = ['EmbeddingType', 'get_emb_sz_list', 'EmbeddingModule', 'MultiLayerPerceptron', 'get_structure']

# %% ../../nbs/03_tabular.model.ipynb 2
