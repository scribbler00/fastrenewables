# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/10_gan.model.ipynb.

# %% auto 0
__all__ = ['LinBnAct', 'GANMLP', 'AuxiliaryDiscriminator']

# %% ../../nbs/10_gan.model.ipynb 2
import numpy as np
import torch
