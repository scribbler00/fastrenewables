# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00c_utils_blitz.ipynb.

# %% auto 0
__all__ = ['convert_layer_to_bayesian', 'convert_to_bayesian_model', 'set_train_mode']

# %% ../nbs/00c_utils_blitz.ipynb 2
#| include: false
